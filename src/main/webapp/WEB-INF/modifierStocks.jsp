  ...
  <body onload="populateTableList()" class="u-body u-overlap u-overlap-contrast u-stick-footer">
          ...
          <main>
            ...
            <div class="text-center my-5">
                <span class="fs-3 text-gray">Modifier les produits au stock, ou enlever les!</span>
            </div>
              ...
              <table class="table table-primary table-striped">
                ...
                <tbody>
                    <c:forEach items="${ stocks }" var="stock">
                        <tr>
                                <td><img src="${stock.getProduit().getUrlImageProduit()}" alt="nom" width="256" height="169" class="rounded"></td>
                                <td class="fs-3">${stock.getProduit().getNomProduit()}</td>
                            <form method="POST" action="/Admin/modifierStocks">
                                <input type="hidden" name="idStock" value="${stock.getId()}">
                                <td class="fs-3"><input type="number" name="nbStock" value="${stock.getNbStock()}"></td>
                                <td><input type="submit" class="btn btn-outline-primary" value="Modifier"></td>
                            </form>
                            <form method="POST" action="/Admin/supprimerStocks">
                                <input type="hidden" name="idStock" value="${stock.getId()}">
