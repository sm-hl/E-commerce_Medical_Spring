  ...
  <body onload="populateTableList()" class="u-body u-overlap u-overlap-contrast u-stick-footer">
          ...
          <main>
            ...
            <div class="text-center my-5">
                <span class="fs-3 text-gray">Suppression des produits</span>
            </div>
                ...
                <table class="table table-primary table-striped">
                    ...
                    <tbody>
                        <c:forEach items="${ produits }" var="produit">
                            <tr>
                                <form method="POST" action="/Admin/supprimerProduits">
                                    <input type="hidden" name="id" value="${produit.getId()}">
                                    <td><img src="${produit.getUrlImageProduit()}" alt="nom" width="256" height="169" class="rounded"></td>
                                    <td class="fs-3">${produit.getNomProduit()}</td>
